...
![Pasted image 20250627004626.png](journal/Pasted%20image%2020250627004626.png)
...
![Pasted image 20250627020525.png](journal/Pasted%20image%2020250627020525.png)

Now time to do the PCB, took me quite a long time because I was figuring out some footprint and alignment stuff.

![Pasted image 20250627020624.png](journal/Pasted%20image%2020250627020624.png)
...
![Pasted image 20250627115129.png](journal/Pasted%20image%2020250627115129.png)
...
![Pasted image 20250627120330.png](journal/Pasted%20image%2020250627120330.png)
...
![Pasted image 20250627152612.png](journal/Pasted%20image%2020250627152612.png)

Now I'm going to make the shapes a bit more complicated to give it some detail. Now it's looking sick.

![Pasted image 20250627154255.png](journal/Pasted%20image%2020250627154255.png)
...
![Pasted image 20250627154432.png](journal/Pasted%20image%2020250627154432.png)

And the minor details are really starting to add up.

![Pasted image 20250627154908.png](journal/Pasted%20image%2020250627154908.png)

Now I want some of those extra thin lines. It's starting to look incredible!

![Pasted image 20250627155635.png](journal/Pasted%20image%2020250627155635.png)

Next I added the circles and the logo. The logo is done in inkscape with the Cynata font.

![Pasted image 20250629003225.png](journal/Pasted%20image%2020250629003225.png)

Next I added some walls to it, and then created the plate and top plate.

![Pasted image 20250629003315.png](journal/Pasted%20image%2020250629003315.png)
...
![Pasted image 20250630003341.png](journal/Pasted%20image%2020250630003341.png)
...
![Pasted image 20250630003446.png](journal/Pasted%20image%2020250630003446.png)
...
![Pasted image 20250701004438.png](journal/Pasted%20image%2020250701004438.png)
...
![Pasted image 20250701231210.png](journal/Pasted%20image%2020250701231210.png)
...
![Pasted image 20250703001012.png](journal/Pasted%20image%2020250703001012.png)
...
![Pasted image 20250703001123.png](journal/Pasted%20image%2020250703001123.png)

Now I completely forgot to add the neopixels so let me do that real quick.

![Pasted image 20250703010923.png](journal/Pasted%20image%2020250703010923.png)

Rewired + new schematic.

![Pasted image 20250703010949.png](journal/Pasted%20image%2020250703010949.png)

Next I did the firmware. It was really simple, just some python with KMK.

![Pasted image 20250703152029.png](journal/Pasted%20image%2020250703152029.png)

Next I completely forgot but I needed a USB port so I added that in.

![Pasted image 20250703152156.png](journal/Pasted%20image%2020250703152156.png)

Then I'll just add the bolt heads and such, and we're done with the case!

![Pasted image 20250705194413.png](journal/Pasted%20image%2020250705194413.png)
...
![Pasted image 20250705194937.png](journal/Pasted%20image%2020250705194937.png)
...
![Pasted image 20250705195234.png](journal/Pasted%20image%2020250705195234.png)
...
![Pasted image 20250705222145.png](journal/Pasted%20image%2020250705222145.png)
...
![Pasted image 20250705224005.png](journal/Pasted%20image%2020250705224005.png)
